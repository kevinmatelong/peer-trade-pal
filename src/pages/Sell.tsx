    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="container px-4 py-8 flex-1 sm:px-6 sm:py-12">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold tracking-tight">Sell Crypto P2P</h1>
          <CryptoSelector selected={selectedCrypto} onSelect={setSelectedCrypto} />
        </div>
        <p className="mt-2 text-muted-foreground">
          Find buyers looking to purchase cryptocurrencies at competitive prices with various payment methods.
        </p>
